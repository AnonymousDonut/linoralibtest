...
LeftGroupBox:AddToggle('Speed farm', {
    Text = 'Generates you infinite speed via remote spam',
    Default = false, -- Default value (true / false)
    Tooltip = 'Currently working', -- Information shown when you hover over the toggle
